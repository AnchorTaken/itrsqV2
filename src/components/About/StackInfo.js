    ...
    >
      ...
      <div className="singl-stack">
            ...
            <p>
              ...
              <span><b>Here are some companies that use React:</b>  Netflix, Yahoo, Airbnb, Sony, Facebook,
              Instagram, WhatsApp & many more.</span>
      ...
      <div className="singl-stack">
          <div className="text-holder">
            ...
            <p>
              ...
              <span><b>Here are some companies that use Node.js:</b>  GooDaddy,
              IBM, LinkedIn, Microsoft, Netlfix, Paypal, Rakuten, Yahoo, Amazon
              Web Services & many more.</span>
            </p>
            </div>
          </div>
      </SwiperSlide>
      ...
      <div className="singl-stack">
          <div className="text-holder">
            <h1 > <span style={{color:"#f16326"}}>HTML5</span>, <span style={{color:"#006fb9"}}>CSS3</span> and <span style={{color:"#5ea614"}}>Javascript</span> </h1>
