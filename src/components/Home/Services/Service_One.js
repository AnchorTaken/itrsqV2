...
function Service_One () {
    return (  
        ...
        <p className="under-title">To keep up with the ever-changing web development world, we only use the latest programs and language versions in our programming.</p>
