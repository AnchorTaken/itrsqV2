...
// Img
import aboutIcon from '../assets/img/hero/about.svg';
import howIcon from '../assets/img/about/how.svg';

const About = () => {
  return (
    <div className="core-page">
    <div className="about-us-page">
         <HeroSection title={"About Us"} img={aboutIcon} topTitle={"Welcome to ITRSQ!"}/>
        <div>
          <div className="aboutus-section">
            <div className="left-side"><img src={howIcon} alt="how" /></div>
            <div className="right-side">
              <div className="text-holder">
                <div className="smol-title">About Us</div>
                <div className="main-title">How we ensure your vision comes to life</div>
                <p>
          ...
          <div className="expert-section">
           ...
           <div className="text-holder">
              ...
              <div className="main-title">Bespoke solutions for your business</div>
              <p>
              Development, Communication, Support and Maintenance, ITRSQ goes the extra mile to make sure your experience with us feels completely tailored to your requirements. No matter what your idea is, our engineers will make sure to bring your vision to life. So don’t be shy, send us a message !
              </p>
              </div>
            </div>
            <div className="right-side">
