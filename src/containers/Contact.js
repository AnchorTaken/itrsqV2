...
// IMG
import contactIcon from '../assets/img/hero/contact.svg';
...
import devIcon from '../assets/img/contact/dev.svg';
...
const Contact = () => {
  ...
  return isLoading ? (
    ...
    <div className="contact-new">
      <HeroSection title={"Contact Us"} img={contactIcon} topTitle={"Get in Touch"}/>
      <div className="filler"></div>
     
      <div className="flexxed">
        <div className="right-side"><img src={devIcon} alt="" /></div>
            ...
            <>
              ...
              <div className="double">
                <div className="single">
                  <label for="firstName" className="label-style">First Name <span>*</span></label>
                  <input
                    name="firstName"
                  ...
                  <label for="lastname"  className="label-style">Last Name <span>*</span></label>
                  <input
                    name="lastname"
                ...
                <div className="double">
                <div className="single">
                  <label for="email" className="label-style">Email <span>*</span></label>
                  <input
                    placeholder="Email"
                    name="email"
                    value={from}
              ...
              <div className="single right-mar">
                <label for="msg" className="label-style">Your Message <span>*</span></label>
                <textarea
                  name="msg"
                  id=""
                  cols="30"
      ...
      <div className="get-in-touch">
          ...
          <div className="single">
            <div className="flex-box">
                <div className="icons"><img src={locationIcon} alt="" /></div>
          ...
          <div className="single">
            <div className="flex-box">
                <div className="icons"><img src={phoneIcon} alt="" /></div>
                <div className="gridded">
          ...
          <div className="single">
            <div className="flex-box">
                <div className="icons"><img src={emailIcon} alt="" /></div>
                <div className="gridded">
