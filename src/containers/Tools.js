...
import mobileIcon from "../assets/img/tools/smartphone.png";
import vatIcon from "../assets/img/tools/vat.png";
import wwwIcon from "../assets/img/tools/www.png";
import toolsIcon from '../assets/img/hero/tools.svg';
...
<div className="tools-inner"><HeroSection title={"Tools"} img={toolsIcon} topTitle={"Give our custom tools a try"}/>
    <div className="tool-light">
      <div className="tool-single">
          <div className="left-side"><img src={emailIcon} alt="" /></div>
    ...
    <div className="tool-dark">
      <div className="tool-single">
          ...
          <div className="right-side"><img src={mobileIcon} alt="" /></div>
        </div>
    </div>
    <div className="tool-light">
      <div className="tool-single">
          <div className="left-side"><img src={vatIcon} alt="" /></div>
          <div className="right-side">
            <div className="text-holder">
    ...
    <div className="tool-dark">
      <div className="tool-single">
          ...
          <div className="right-side"><img src={wwwIcon} alt="" /></div>
        </div>    
    </div>
